  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-2 text-sm text-slate-500 mb-6 bg-white py-3 px-5 rounded-xl border border-slate-100 shadow-sm w-fit">
        ...
        <span>/</span>
        <Link href={`/courses/${id}`} className="hover:text-blue-600 transition-colors font-medium text-slate-700 truncate max-w-[200px]">Advanced Prompt Engineering</Link>
        <span>/</span>
        <span className="text-blue-600 font-bold bg-blue-50 px-2 py-0.5 rounded-md">Module {moduleId}</span>
      </div>
